...
export const changeQuantityInCart = async (id,data)=>{
    const req = await axios.put(`${URL}/cart/${id}/change_quantity/`,data, getConfig())
    return req.data
}

export const getFilterProductByName= async (name)=>{
